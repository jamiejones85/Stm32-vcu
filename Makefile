...
OBJSL		= $(BINARY).o hwinit.o stm32scheduler.o params.o terminal.o terminal_prj.o \
           ...
           CPC.o ElconCharger.o RearOutlanderinverter.o linbus.o VWheater.o JLR_G1.o JLR_G2.o Focci.o kangoobms.o digipot.o\
		   E65_Lever.o OutlanderCanHeater.o OutlanderHeartBeat.o
