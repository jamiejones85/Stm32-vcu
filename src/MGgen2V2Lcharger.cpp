...
void MGgen2V2Lcharger::Task100Ms()
{
   ...
   // if(opmode==MOD_RUN) //do some DC-DC stuff
    //{
        ...
        bytes[3] = 0x00;  //9F or A0 in v2L log
        bytes[4] = 0x00;  //7F?
        bytes[5] = 0x00;  //FF or FE in v2l
        bytes[6] = 0x00;    //0B or 01 or 04 or 0F or 00 or 05 or 09 
        bytes[7] = 0x7F; 
        ...
        bytes[6] = 0x00; 
        if (messageCount > 50) {
        bytes[7] = 0x48; // 46 start V2l? or 48
        } else {
